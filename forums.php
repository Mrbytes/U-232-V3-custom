...
if ($INSTALLER09['forums_online'] == 0 AND $CURUSER['class'] < UC_STAFF) stderr('Information', 'The forums are currently offline for maintainance work');
...
$more_options = '<div id="tools" '.((isset($_POST['poll_question']) && $_POST['poll_question'] !== '') ? '' : 'style="display:none"').' >
	...
	'.($CURUSER['class'] < $min_upload_class ? '' : '<tr>
