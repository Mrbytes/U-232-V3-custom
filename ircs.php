...
if ((isset($_GET['pass']) && $_GET['pass'] == $password) && (isset($_GET['hash']) && $_GET['hash'] == $hash)) {
    ...
    if (isset($_GET['search'])) {
        ...
        $res = sql_query("SELECT * FROM ".TBL_USERS." WHERE $query ORDER BY username") or sqlerr(__FILE__, __LINE__);
        ...
        if ($num > 0) {
            ...
            if (isset($_GET['func']) && $_GET['func'] == "stats") {
                ...
                $res5 = sql_query("SELECT connectable FROM ".TBL_PEERS." WHERE userid=".sqlesc($arr['id'])) or sqlerr(__FILE__, __LINE__);
                ...
                sql_query("DELETE FROM ".TBL_PEERS." WHERE userid = ".$id);
        ...
        $res = sql_query("SELECT id FROM ".TBL_USERS." WHERE username = $whom AND class < $modclass LIMIT 1") or sqlerr(__FILE__, __LINE__);
        $nsetusername = mysqli_fetch_assoc($res);
        $res2 = sql_query("SELECT id FROM ".TBL_USERS." WHERE username = $newname LIMIT 1") or sqlerr(__FILE__, __LINE__);
        ...
        if ($nsetusername < 1) echo $who." - No such user or is staff, please try again.";
            ...
            if ($nnewname) echo $newname." - Is taken, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET username = $newname, modcomment = CONCAT($modcomment,modcomment) WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
        ...
        $res = sql_query("SELECT id, username, class, irctotal FROM ".TBL_USERS." WHERE onirc = 'yes' GROUP BY class ORDER BY irctotal DESC") or sqlerr(__FILE__, __LINE__);
        ...
        $res = sql_query("SELECT COUNT(*) FROM ".TBL_TORRENTS." WHERE visible='yes'") or sqlerr(__FILE__, __LINE__);
        $row = mysqli_fetch_array($res, MYSQLI_NUM);
        $count = $row[0];
        echo '-'.$count.' torrents found';
    } elseif (isset($_GET['includedead'])) {
        $res = sql_query("SELECT COUNT(*) FROM ".TBL_TORRENTS."") or sqlerr(__FILE__, __LINE__);
        $row = mysqli_fetch_array($res, MYSQLI_NUM);
        $count = $row[0];
        echo '-'.$count.' torrents found';
    } elseif (isset($_GET['onlydead'])) {
        $res = sql_query("SELECT COUNT(*) FROM ".TBL_TORRENTS." WHERE visible='no'") or sqlerr(__FILE__, __LINE__);
        $row = mysqli_fetch_array($res, MYSQLI_NUM);
        $count = $row[0];
        echo '-'.$count.' torrents found';
    } elseif (isset($_GET['noseeds'])) {
        $res = sql_query("SELECT COUNT(*) FROM ".TBL_TORRENTS." WHERE seeders = '0'") or sqlerr(__FILE__, __LINE__);
        $row = mysqli_fetch_array($res, MYSQLI_NUM);
        $count = $row[0];
        echo '-'.$count.' torrents found';
        ...
        if (isset($_GET['bonus'])) {
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $res = sql_query("SELECT id, seedbonus FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($nbonus < 1) echo $who." - No such user, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET seedbonus = seedbonus+".sqlesc($amount)." WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
                ...
                $mc1->commit_transaction($INSTALLER09['expires']['user_stats']);
                $res1 = sql_query("SELECT seedbonus FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res3 = sql_query("SELECT id, invites FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($ninvites < 1) echo $who." - No such user, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET invites = invites+".sqlesc($amount)." WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
                ...
                $mc1->commit_transaction($INSTALLER09['expires']['curuser']);
                $res4 = sql_query("SELECT invites FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res5 = sql_query("SELECT id, freeslots FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($nfreeslots < 1) echo $who." - No such user, please try again.";
                ...
                $amount = (isset($_GET['amount']) && $_GET['amount'] > 0 ? 0 + $_GET['amount'] : '');
                sql_query("UPDATE ".TBL_USERS." SET freeslots = freeslots+".sqlesc($amount)." WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
                ...
                $mc1->commit_transaction($INSTALLER09['expires']['curuser']);
                $res6 = sql_query("SELECT freeslots FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res3 = sql_query("SELECT id, reputation FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($nreputation < 1) echo $who." - No such user, please try again.";
                ...
                $amount = (isset($_GET['amount']) && $_GET['amount'] > 0 ? 0 + $_GET['amount'] : '');
                sql_query("UPDATE ".TBL_USERS." SET reputation = reputation+".sqlesc($amount)." WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
                ...
                $mc1->commit_transaction($INSTALLER09['expires']['curuser']);
                $res4 = sql_query("SELECT reputation FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
        ...
        if (isset($_GET['bonus'])) {
            ...
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res5 = sql_query("SELECT id, reputation FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($nreputation < 1) echo $who." - No such user, please try again.";
                ...
                $mc1->commit_transaction($INSTALLER09['expires']['curuser']);
                $res6 = sql_query("SELECT reputation FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
        ...
        if (isset($_GET['bonus'])) {
            ...
            $res9 = sql_query("SELECT id, seedbonus FROM ".TBL_USERS." WHERE username = $me LIMIT 1") or sqlerr(__FILE__, __LINE__);
            $mebonus = mysqli_fetch_assoc($res9);
            $res99 = sql_query("SELECT id, seedbonus FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($whombonus < 1) echo $who." - No such user, please try again.";
                ...
                if ($amount <= $meoldbonus) {
                    sql_query("UPDATE ".TBL_USERS." SET seedbonus = seedbonus-".sqlesc($amount)." WHERE username = $me") or sqlerr(__FILE__, __LINE__);
                    sql_query("UPDATE ".TBL_USERS." SET seedbonus = seedbonus+".sqlesc($amount)." WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
                    ...
                    $mc1->commit_transaction($INSTALLER09['expires']['user_stats']);
                    $res1 = sql_query("SELECT seedbonus FROM ".TBL_USERS." WHERE username = $me LIMIT 1") or sqlerr(__FILE__, __LINE__);
                    $meobonus = mysqli_fetch_assoc($res1);
                    $res2 = sql_query("SELECT seedbonus FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $m = (isset($_GET['me']) ? htmlsafechars($_GET['me']) : '');
            $res9 = sql_query("SELECT id, freeslots FROM ".TBL_USERS." WHERE username = $me LIMIT 1") or sqlerr(__FILE__, __LINE__);
            $mefreeslots = mysqli_fetch_assoc($res9);
            $res99 = sql_query("SELECT id, freeslots FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($whomfreeslots < 1) echo $who." - No such user, please try again.";
                ...
                if ($amount <= $meoldfreeslots) {
                    sql_query("UPDATE ".TBL_USERS." SET freeslots = freeslots-".sqlesc($amount)." WHERE username = $me") or sqlerr(__FILE__, __LINE__);
                    sql_query("UPDATE ".TBL_USERS." SET freeslots = freeslots+".sqlesc($amount)." WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
                    ...
                    $mc1->commit_transaction($INSTALLER09['expires']['curuser']);
                    $res1 = sql_query("SELECT freeslots FROM ".TBL_USERS." WHERE username = $me LIMIT 1") or sqlerr(__FILE__, __LINE__);
                    $meofreeslots = mysqli_fetch_assoc($res1);
                    $res2 = sql_query("SELECT freeslots FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $m = (isset($_GET['me']) ? htmlsafechars($_GET['me']) : '');
            $res9 = sql_query("SELECT id, reputation FROM ".TBL_USERS." WHERE username = $me LIMIT 1") or sqlerr(__FILE__, __LINE__);
            $mereputation = mysqli_fetch_assoc($res9);
            $res99 = sql_query("SELECT id, reputation FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($whomreputation < 1) echo $who." - No such user, please try again.";
                ...
                if ($amount <= $meoldreputation) {
                    sql_query("UPDATE ".TBL_USERS." SET reputation = reputation-".sqlesc($amount)." WHERE username = $me") or sqlerr(__FILE__, __LINE__);
                    sql_query("UPDATE ".TBL_USERS." SET reputation = reputation+".sqlesc($amount)." WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
                    ...
                    $mc1->commit_transaction($INSTALLER09['expires']['curuser']);
                    $res1 = sql_query("SELECT reputation FROM ".TBL_USERS." WHERE username = $me LIMIT 1") or sqlerr(__FILE__, __LINE__);
                    $meoreputation = mysqli_fetch_assoc($res1);
                    $res2 = sql_query("SELECT reputation FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $m = (isset($_GET['me']) ? htmlsafechars($_GET['me']) : '');
            $res9 = sql_query("SELECT id, invites FROM ".TBL_USERS." WHERE username = $me LIMIT 1") or sqlerr(__FILE__, __LINE__);
            $meinvites = mysqli_fetch_assoc($res9);
            $res99 = sql_query("SELECT id, invites FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($whominvites < 1) echo $who." - No such user, please try again.";
                ...
                if ($amount <= $meoldinvites) {
                    sql_query("UPDATE ".TBL_USERS." SET invites = invites-".sqlesc($amount)." WHERE username = $me") or sqlerr(__FILE__, __LINE__);
                    sql_query("UPDATE ".TBL_USERS." SET invites = invites+".sqlesc($amount)." WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
                    ...
                    $mc1->commit_transaction($INSTALLER09['expires']['curuser']);
                    $res1 = sql_query("SELECT invites FROM ".TBL_USERS." WHERE username = $me LIMIT 1") or sqlerr(__FILE__, __LINE__);
                    $meoinvites = mysqli_fetch_assoc($res1);
                    $res2 = sql_query("SELECT invites FROM ".TBL_USERS." WHERE username = $whom LIMIT 1") or sqlerr(__FILE__, __LINE__);
        ...
        if ((isset($_GET['toggle']) && $_GET['toggle'] == 1) || (isset($_GET['toggle']) && $_GET['toggle'] == 0)) {
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res = sql_query("SELECT id, uploadpos FROM ".TBL_USERS." WHERE username = $whom AND class < $modclass LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($upos < 1) echo $who." - No such user or is staff, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET uploadpos = '$toggle', modcomment = CONCAT($modcomment,modcomment) WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
        ...
        if ((isset($_GET['toggle']) && $_GET['toggle'] == 1) || (isset($_GET['toggle']) && $_GET['toggle'] == 0)) {
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res = sql_query("SELECT id, downloadpos FROM ".TBL_USERS." WHERE username = $whom AND class < $modclass LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($dpos < 1) echo $who." - No such user or is staff, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET downloadpos = '$toggle', modcomment = CONCAT($modcomment,modcomment) WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
        ...
        if ((isset($_GET['toggle']) && $_GET['toggle'] == "yes") || (isset($_GET['toggle']) && $_GET['toggle'] == "no")) {
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res = sql_query("SELECT id, forum_post FROM ".TBL_USERS." WHERE username = $whom AND class < $modclass LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($fpos < 1) echo $who." - No such user or is staff, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET forum_post = '$toggle', modcomment = CONCAT($modcomment,modcomment) WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
        ...
        if ((isset($_GET['toggle']) && $_GET['toggle'] == 1) || (isset($_GET['toggle']) && $_GET['toggle'] == 0)) {
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res = sql_query("SELECT id, chatpost FROM ".TBL_USERS." WHERE username = $whom AND class < $modclass LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($cpos < 1) echo $who." - No such user or is staff, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET chatpost = '$toggle', modcomment = CONCAT($modcomment,modcomment) WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
        ...
        if ((isset($_GET['toggle']) && $_GET['toggle'] == 1) || (isset($_GET['toggle']) && $_GET['toggle'] == 0)) {
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res = sql_query("SELECT id, avatarpos FROM ".TBL_USERS." WHERE username = $whom AND class < $modclass LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($apos < 1) echo $who." - No such user or is staff, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET avatarpos = '$toggle', modcomment = CONCAT($modcomment,modcomment) WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
        ...
        if ((isset($_GET['toggle']) && $_GET['toggle'] == "yes") || (isset($_GET['toggle']) && $_GET['toggle'] == "no")) {
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res = sql_query("SELECT id, invite_rights FROM ".TBL_USERS." WHERE username = $whom AND class < $modclass LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($ipos < 1) echo $who." - No such user or is staff, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET invite_rights = '$toggle', modcomment = CONCAT($modcomment,modcomment) WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
        ...
        if ((isset($_GET['toggle']) && $_GET['toggle'] == "yes") || (isset($_GET['toggle']) && $_GET['toggle'] == "no")) {
            $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
            $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
            $res = sql_query("SELECT id, enabled FROM ".TBL_USERS." WHERE username = $whom AND class < $modclass LIMIT 1") or sqlerr(__FILE__, __LINE__);
            ...
            if ($epos < 1) echo $who." - No such user or is staff, please try again.";
                ...
                sql_query("UPDATE ".TBL_USERS." SET enabled = '$toggle', modcomment = CONCAT($modcomment,modcomment) WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
        ...
        $whom = (isset($_GET['whom']) ? sqlesc($_GET['whom']) : '');
        $who = (isset($_GET['whom']) ? htmlsafechars($_GET['whom']) : '');
        $res = sql_query("SELECT id, support, supportfor FROM ".TBL_USERS." WHERE username = $whom AND class < $modclass LIMIT 1") or sqlerr(__FILE__, __LINE__);
        ...
        if ($support < 1) echo $who." - No such user or is staff, please try again.";
            ...
            sql_query("UPDATE ".TBL_USERS." SET support = 'yes', supportfor ='$supportfors', modcomment = CONCAT($modcomment,modcomment) WHERE username = $whom") or sqlerr(__FILE__, __LINE__);
