...
function docleanup($data)
{
    ...
    $res = sql_query("SELECT ".TBL_USERS.".id, ".TBL_USERS.".numuploads, ".TBL_USERSACHIEV.".ul FROM ".TBL_USERS." LEFT JOIN ".TBL_USERSACHIEV." ON ".TBL_USERS.".id = ".TBL_USERSACHIEV.".id WHERE enabled = 'yes' AND numuploads >= '1'") or sqlerr(__FILE__, __LINE__);
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            $ul = (int)$arr['ul'];
            if ($uploads >= 1 && $ul == 0) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL1[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul1.png[/img]");
            ...
            if ($uploads >= 50 && $ul == 1) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL2[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul2.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($uploads >= 100 && $ul == 2) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL3[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul3.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($uploads >= 200 && $ul == 3) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL4[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul4.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($uploads >= 300 && $ul == 4) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL5[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul5.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($uploads >= 500 && $ul == 5) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL6[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul6.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($uploads >= 800 && $ul == 6) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL7[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul7.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($uploads >= 1000 && $ul == 7) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL8[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul8.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($uploads >= 1500 && $ul == 8) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL9[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul9.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($uploads >= 2000 && $ul == 9) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Uploader LVL10[/b] achievement. :) [img]http://u-232.com/pic/achievements/ul10.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
