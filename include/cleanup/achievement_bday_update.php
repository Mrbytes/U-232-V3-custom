...
function docleanup($data)
{
    ...
    $res = sql_query("SELECT ".TBL_USERS.".id, ".TBL_USERS.".added, ".TBL_USERSACHIEV.".bday FROM ".TBL_USERS." LEFT JOIN ".TBL_USERSACHIEV." ON ".TBL_USERS.".id = ".TBL_USERSACHIEV.".id WHERE enabled = 'yes' AND added < $maxdt") or sqlerr(__FILE__, __LINE__);
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            if ($bday == 0 && $added < $maxdt) {
                $msg = sqlesc("Congratulations, you have just earned the [b]First Birthday[/b] achievement. :) [img]http://u-232.com/pic/achievements/birthday1.png[/img]");
