...
function docleanup($data)
{
    ...
    $res = sql_query("SELECT ".TBL_USERS.".id, ".TBL_USERS.".seedbonus, ".TBL_USERSACHIEV.".bonus FROM ".TBL_USERS." LEFT JOIN ".TBL_USERSACHIEV." ON ".TBL_USERS.".id = ".TBL_USERSACHIEV.".id WHERE enabled = 'yes' AND ".TBL_USERS.".seedbonus >= '1' AND usersachiev.bonus >= '0'") or sqlerr(__FILE__, __LINE__);
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            if ($seedbonus >= 1 && $lvl == 0) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL1[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus1.png[/img]");
            ...
            if ($seedbonus >= 100 && $lvl == 1) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL2[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus2.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 500 && $lvl == 2) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL3[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus3.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 1000 && $lvl == 3) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL4[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus4.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 2000 && $lvl == 4) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL5[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus5.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 5000 && $lvl == 5) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL6[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus6.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 10000 && $lvl == 6) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL7[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus7.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 30000 && $lvl == 7) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL8[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus8.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 70000 && $lvl == 8) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL9[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus9.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 100000 && $lvl == 9) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL10[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus10.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($seedbonus >= 1000000 && $lvl == 10) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Bonus Banker LVL11[/b] achievement. :) [img]http://u-232.com/pic/achievements/bonus11.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
