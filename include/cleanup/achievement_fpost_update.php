...
function docleanup($data)
{
    ...
    $res = sql_query("SELECT id, forumposts, postachiev FROM ".TBL_USERSACHIEV." WHERE forumposts >= '1'") or sqlerr(__FILE__, __LINE__);
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            if ($posts >= 1 && $lvl == 0) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Forum Poster Level 1[/b] achievement. :) [img]http://u-232.com/pic/achievements/fpost1.png[/img]");
            ...
            if ($posts >= 25 && $lvl == 1) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Forum Poster Level 2[/b] achievement. :) [img]http://u-232.com/pic/achievements/fpost2.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($posts >= 50 && $lvl == 2) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Forum Poster Level 3[/b] achievement. :) [img]http://u-232.com/pic/achievements/fpost3.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($posts >= 100 && $lvl == 3) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Forum Poster Level 4[/b] achievement. :) [img]http://u-232.com/pic/achievements/fpost4.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($posts >= 250 && $lvl == 4) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Forum Poster Level 5[/b] achievement. :) [img]http://u-232.com/pic/achievements/fpost5.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($posts >= 500 && $lvl == 5) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Forum Poster Level 6[/b] achievement. :) [img]http://u-232.com/pic/achievements/fpost6.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
            ...
            if ($posts >= 750 && $lvl == 6) {
                $msg = sqlesc("Congratulations, you have just earned the [b]Forum Poster Level 7[/b] achievement. :) [img]http://u-232.com/pic/achievements/fpost7.png[/img]");
                $msgs_buffer[] = '(0,' . $arr['id'] . ',' . TIME_NOW . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')';
