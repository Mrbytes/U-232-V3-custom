...
if (count($scroll_torrents) > 0) {
    ...
    if ($scroll_torrents) {
        foreach ($scroll_torrents as $s_t) {
            ...
            if ($i == 0) $HTMLOUT.= "</span></span><span id=\"vmarquee2\" style=\"position: absolute; width: 98%;\"></span></div></div><div style=\"overflow:hidden\"><div id=\"marqueecontainer\" onmouseover=\"copyspeed=pausespeed\" onmouseout=\"copyspeed=marqueespeed\"> <span id=\"vmarquee\" style=\"position: absolute; width: 98%;\"><span style=\"white-space: nowrap;\">";
        ...
        if (empty($scroll_torrents)) $HTMLOUT.= "No torrents here yet</div></div></div><br />";
    }
}
//== end 09 poster mod
// End Class
