...
if ($news === false) {
    $res = sql_query("SELECT ".$prefix.".id AS nid, ".$prefix.".userid, ".$prefix.".added, ".$prefix.".title, ".$prefix.".body, ".$prefix.".sticky, u.username, u.id, u.class, u.warned, u.chatpost, u.pirate, u.king, u.leechwarn, u.enabled, u.donor FROM ".TBL_NEWS." AS ".$prefix." LEFT JOIN ".TBL_USERS." AS u ON u.id = ".$prefix.".userid WHERE ".$prefix.".added + ( 3600 *24 *45 ) > ".TIME_NOW." ORDER BY sticky, ".$prefix.".added DESC LIMIT 10") or sqlerr(__FILE__, __LINE__);
...
if (empty($news)) $HTMLOUT.= "We currently have fuck all to say :-P
    </div><br />\n";
//==End
// End Class
// End File
