...
$qs = sql_query('SELECT count(t.id) as tickets , u.username, u.id, u.seedbonus FROM '.TBL_TICKETS.' as t LEFT JOIN '.TBL_USERS.' as u ON u.id = t.user GROUP BY u.id ORDER BY tickets DESC, username ASC') or sqlerr(__FILE__, __LINE__);
