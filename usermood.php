...
if (!isset($CURUSER['id'])) die('log in to use this feature!');
...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($res_moods)) {
        ...
        write_log('<b>Mood Change</b> '.$CURUSER['username'].' '.$rmood['name'].'<img src="'.$INSTALLER09['pic_base_url'].'smilies/'.$rmood['image'].'" alt="" />');
    ...
    } else die('Hmmm. Invalid Mood choice.');
}
$HTMLOUT.= '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">		
<html xmlns="http://www.w3.org/1999/xhtml">
