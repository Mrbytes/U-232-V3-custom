...
$HTMLOUT.= "<table align='center' width='750' border='1' cellspacing='0' cellpadding='5'>\n";
//==09 Poster mod
if (!empty($torrents["poster"])) $HTMLOUT.= tr("{$lang['details_poster']}", "<img src='".htmlsafechars($torrents["poster"])."' alt='Poster' title='Poster' />", 1);
