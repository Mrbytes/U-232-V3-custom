...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $res = sql_query("UPDATE ".TBL_USERS." SET uploaded = uploaded * 1.1, tenpercent = 'yes' WHERE id = ".sqlesc($CURUSER['id'])) or sqlerr(__FILE__, __LINE__);
    ...
    $mc1->commit_transaction($INSTALLER09['expires']['user_cache']);
    $res1 = sql_query("INSERT INTO ".TBL_MESSAGES." (sender, poster, receiver, subject, msg, added) VALUES (0, 0, ".sqlesc($CURUSER['id']).", ".sqlesc($subject).", ".sqlesc($msg).", '".TIME_NOW."')") or sqlerr(__FILE__, __LINE__);
