...
$res = sql_query("SELECT ".TBL_USERS.".id, ".TBL_USERS.".username, ".TBL_USERSACHIEV.".achpoints, ".TBL_USERSACHIEV.".spentpoints FROM ".TBL_USERS." LEFT JOIN ".TBL_USERSACHIEV." ON ".TBL_USERS.".id = ".TBL_USERSACHIEV.".id WHERE ".TBL_USERS.".id = " . sqlesc($id)) or sqlerr(__FILE__, __LINE__);
...
$res = sql_query("SELECT COUNT(*) FROM ".TBL_ACHIEVEMENTS." WHERE userid =" . sqlesc($id)) or sqlerr(__FILE__, __LINE__);
...
$res = sql_query("SELECT * FROM ".TBL_ACHIEVEMENTS." WHERE userid=" . sqlesc($id) . " ORDER BY date DESC {$pager['limit']}") or sqlerr(__FILE__, __LINE__);
